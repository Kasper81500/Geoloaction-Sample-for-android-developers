...
public class ReviewListActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void GetReviewList(String profileId){

        SvcApiService.getUserIdEndPoint().getAllReviews(profileId, new SvcApiRestCallback<MapPinResponse>() {
            @Override
                ...
                try {
                    ...
                    if (responseStatus.equals("true")) {
                        ...
                        if (mUserList.size() > 0) {
                            ...
                            adapter = new ReviewListAdapter(ReviewListActivity.this, mUserList);
